...
# Define the features of the new instances
new_instances_data = {
    'Alcohol': [13.5, 12.0, 14.0],
    'Malic Acid': [2.5, 1.5, 3.0],
    'Ash': [2.6, 2.1, 2.8],
    'Alcalinity of Ash': [20.0, 18.0, 26.0],
    'Magnesium': [120, 88, 100],
    'Total Phenols': [2.6, 2.4, 3.2],
    'Flavanoids': [2.9, 2.3, 3.4],
    'Nonflavanoid Phenols': [0.3, 0.2, 0.3],
    'Proanthocyanins': [1.2, 0.8, 1.8],
    'Color Intensity': [3.5, 2.0, 5.3],
    'Hue': [1.1, 0.8, 1.2],
    'OD280/OD315 of Diluted Wines': [2.7, 3.0, 2.8],
    'Proline': [1000, 520, 900]
}

# Convert the new instances data to a DataFrame
new_instances_df = pd.DataFrame(new_instances_data)

# Display the summary statistics of the new instances
print("Summary Statistics of New Instances:")
print(new_instances_df.describe())

# Visualize the distribution of features in the new instances using boxplots
plt.figure(figsize=(12, 8))
sns.boxplot(data=new_instances_df, palette='viridis')
plt.title("Boxplot of Features in New Instances")
plt.xticks(rotation=45)
plt.show()

# Visualize the correlation between features in the new instances using a heatmap
plt.figure(figsize=(10, 8))
sns.heatmap(new_instances_df.corr(), annot=True, cmap='coolwarm')
plt.title("Correlation Heatmap of Features in New Instances")
plt.show()
